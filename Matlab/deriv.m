...
% DERIV Calculates central difference numerical derivatives
%   d = deriv(x,y,dim,ord,iseven)
%
...
%
% Copyright (c) 2023 Eric Tytell, Tufts University
if (nargin < 4)
    ord = 1;
    if (nargin < 3)
        dim = [];
